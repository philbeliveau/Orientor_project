...
# Test configuration
RAILWAY_URL = "https://orientor-project-production.up.railway.app"
LOCAL_URL = "http://localhost:8000"

# Use Railway by default, fallback to local
...
def main():
    ...
    railway_tester = OrientorTester(RAILWAY_URL)
    railway_success = railway_tester.run_all_tests()
    
    print("\n" + "=" * 60)
    print(f"🎯 FINAL RESULT: {'✅ DEPLOYMENT READY' if railway_success else '❌ DEPLOYMENT ISSUES'}")
    print("=" * 60)
