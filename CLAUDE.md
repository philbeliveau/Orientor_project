...
- `docs/Louis-deployment/hive-mind/ERROR_REGISTRY.md` - All known issues and solutions
- `docs/Louis-deployment/hive-mind/STANDARDIZED_DEPLOYMENT_GUIDE.md` - Deployment standards and patterns
